    ...
    <div class="block">
        <form action="{{ route('pengguna.store') }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="form-row">
                    <div class="form-column">
                        <label class="form-label" for="password">Password <span style="color: #D20D24;">*</span></label>
                        <input type="password" id="password" name="password" class="form-input" placeholder="Masukkan password..." required>
                    </div>
                    <div class="form-column">
                        <label class="form-label" for="password_confirmation">Konfirmasi Password <span style="color: #D20D24;">*</span></label>
                        <input type="password" id="password_confirmation" name="password_confirmation" class="form-input" placeholder="Konfirmasi password..." required>
                    </div>
                </div>
