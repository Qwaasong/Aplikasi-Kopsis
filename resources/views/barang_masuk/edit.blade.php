...
@section('content')
    ...
    <div class="block">
        <form action="{{ route('barang_masuk.update', $purchase->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-column">
                        ...
                        <input type="date" id="tanggal" name="tanggal" class="form-input" 
                            value="{{ $purchase->tanggal }}" required>  {{-- HAPUS ->format() --}}
                    </div>
                    <div class="form-column">
            ...
            <div class="button-container">
                ...
                <a href="api/purchase" class="btn btn-cancel">Batal</a>
            </div>
        </form>
    </div>
@endsection