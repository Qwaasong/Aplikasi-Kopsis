...
@section('title', 'KopsisApp - Edit Riwayat Transaksi')
...
@section('content')
    ...
    <div class="judul">
        <h2 class="font-bold">Edit Riwayat Transaksi</h2>
    </div>

    <div class="block">
        <form action="{{ route('riwayat_transaksi.update', $transaction->id) }}" method="POST">
            @csrf
            @method('PUT')
